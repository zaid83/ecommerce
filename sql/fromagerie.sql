...
--
-- Host: localhost
-- Generation Time: Aug 03, 2018 at 11:49 AM
...
--
-- Table structure for table `pays_fromage`
--
...
--
-- Indexes for table `commande_articles`
--
...
--
-- Indexes for table `pays_fromage`
--
...
--
ALTER TABLE `commandes`
  MODIFY `id_commande` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=135;
--
...
--
-- Constraints for table `pays_fromage`
--
ALTER TABLE `pays_fromage`
