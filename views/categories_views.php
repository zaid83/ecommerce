...
<body style ="background-color:white; color:black;" class="text-center">
    ...
    <div class="categorie_lait" >
        ...
        <?php if ($_GET['categories'] == 2){ ?>
            <a href="categories_views.php?categories=2"><img src="../assets/img_fromages/mouton.png" class="img_categ" alt="logo de mouton" width="150">  LISTE DES FROMAGES PROVENANTS DE LA BREBIS</a>
        <?php } else if ($_GET['categories'] == 1){ ?>
            <a href="categories_views.php?categories=1"><img src="../assets/img_fromages/vache.png" class="img_categ"  alt="logo de vache" width="150">LISTE DES FROMAGES PROVENANTS DE LA VACHE</a>
        <?php } else { ?>
          <a href="categories_views.php?categories=3"><img src="../assets/img_fromages/chevre.png" class="img_categ"  alt="logo de chevre" width="150">LISTE DES FROMAGES PROVENANTS DE LA CHEVRE</a>
      <?php } ?>
      <br>
      <br>
